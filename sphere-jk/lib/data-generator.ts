...
export interface LifeTrajectory {
  ...
  measure: "MIS" | "Ecotrek" | "JobtrekSchool" | "Apprentissage" // Ajout du type de mesure
  startYear: number
  points: LifePoint[]
  maxHeight: number
}
...
// Types de mesures
const measures = ["MIS", "Ecotrek", "JobtrekSchool", "Apprentissage"] as const
...
function generateTrajectory(): LifeTrajectory {
  ...
  // Assigner une mesure aléatoire
  const measure = randomChoice(measures)
